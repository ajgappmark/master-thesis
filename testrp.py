...
for key in actions.iterkeys():
    ...
    for i in x:
        ...
        #print
    results[key] = dict()
    results[key]["durations"] = np.mean(durations)
    results[key]["distances"] = np.mean(distances)
...
for key in results.iterkeys():
    plt.plot(x, results[key]["distances"], label="distances")
...
for key in results.iterkeys():
    plt.plot(x, results[key]["durations"], label="durations")
